...
os.system ("ls -f $PWD/*.ibs > results.txt")
...
a1 = "gnome-terminal " + "\"" + "ibischk6" + " " + a + "\""
b1 = "gnome-terminal --tab -e " + "\"" + "ibischk6" + " " + b + "\""
c1 = "gnome-terminal --tab -e " + "\"" + "ibischk6" + " " + c + "\""
d1 = "gnome-terminal --tab -e " + "\"" + "ibischk6" + " " + d + "\""
e1 = "gnome-terminal --tab -e " + "\"" + "ibischk6" + " " + e + "\""
f1 = "gnome-terminal --tab -e " + "\"" + "ibischk6" + " " + f + "\""
g1 = "gnome-terminal --tab -e " + "\"" + "ibischk6" + " " + g + "\""
h1 = "gnome-terminal --tab -e " + "\"" + "ibischk6" + " " + h + "\""
i1 = "gnome-terminal --tab -e " + "\"" + "ibischk6" + " " + i + "\""
j1 = "gnome-terminal --tab -e " + "\"" + "ibischk6" + " " + j + "\""
k1 = "gnome-terminal --tab -e " + "\"" + "ibischk6" + " " + k + "\""
l1 = "gnome-terminal --tab -e " + "\"" + "ibischk6" + " " + l + "\""
...
#p = "gnome-terminal --tab -e \"spectre dout2_ivmax.sp\" ; gnome-terminal --tab -e \"spectre dout2_ivmin.sp\" ; gnome-terminal --tab -e \"spectre dout2_ivtyp.sp\""
