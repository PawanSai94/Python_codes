...
a1 = "gnome-terminal --tab -e " + "\"" + "spectre ++aps" + " " + a + "\""
b1 = "gnome-terminal --tab -e " + "\"" + "spectre ++aps" + " " + b + "\""
c1 = "gnome-terminal --tab -e " + "\"" + "spectre ++aps" + " " + c + "\""
d1 = "gnome-terminal --tab -e " + "\"" + "spectre ++aps" + " " + d + "\""
e1 = "gnome-terminal --tab -e " + "\"" + "spectre ++aps" + " " + e + "\""
f1 = "gnome-terminal --tab -e " + "\"" + "spectre ++aps" + " " + f + "\""
g1 = "gnome-terminal --tab -e " + "\"" + "spectre ++aps" + " " + g + "\""
h1 = "gnome-terminal --tab -e " + "\"" + "spectre ++aps" + " " + h + "\""
i1 = "gnome-terminal --tab -e " + "\"" + "spectre ++aps" + " " + i + "\""
j1 = "gnome-terminal --tab -e " + "\"" + "spectre ++aps" + " " + j + "\""
k1 = "gnome-terminal --tab -e " + "\"" + "spectre ++aps" + " " + k + "\""
l1 = "gnome-terminal --tab -e " + "\"" + "spectre ++aps" + " " + l + "\""
