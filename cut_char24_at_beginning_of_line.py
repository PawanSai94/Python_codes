import os
prompt = '> '
print "Hello Pawan! Enter Character to be CUT"
garbage_number = raw_input(prompt)
sed_cmd = "sed 's/^" + garbage_number + "//' " 
#lw_diff_v2_redo3_ivmax.sp > out.txt"
...
for i in range(len(linelist)):
	temp1_sed_cmd = sed_cmd + linelist[i] + " > out.txt"
	#print temp1_sed_cmd
	os.system (temp1_sed_cmd)
	temp2_sed_cmd = "mv out.txt " + linelist[i]
	os.system(temp2_sed_cmd)
print  "Done"
