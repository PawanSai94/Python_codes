...
#a0cat = a [-12:]
#print a0cat
#rep = a0cat.replace("spi","out")
#print rep
#msg=a0cat.replace("spi","msg")
#print msg
#
a0cat = a [-12:]
b0cat = b [-12:]
...
oz = z0cat.replace("spi","out")
oaa= aacat.replace("spi","out")
oab= abcat.replace("spi","out")
oac= accat.replace("spi","out")
oad= adcat.replace("spi","out")
oae= aecat.replace("spi","out")
oaf= afcat.replace("spi","out")
oag= agcat.replace("spi","out")
oah= ahcat.replace("spi","out")
oai= aicat.replace("spi","out")
oaj= ajcat.replace("spi","out")
oak= akcat.replace("spi","out")
#
...
mz =z0cat.replace("spi","msg")
maa=aacat.replace("spi","msg")
mab=abcat.replace("spi","msg")
mac=accat.replace("spi","msg")
mad=adcat.replace("spi","msg")
mae=aecat.replace("spi","msg")
maf=afcat.replace("spi","msg")
mag=agcat.replace("spi","msg")
mah=ahcat.replace("spi","msg")
mai=aicat.replace("spi","msg")
maj=ajcat.replace("spi","msg")
mak=akcat.replace("spi","msg")
#
#
# print a
# print b
...
z1  = "gnome-terminal --tab -e " + "\"" + "spectre -f nutascii -cols 132 +errpreset=conservative" + " " + z + " -r " + oz + " =l " + mz +  "\""
aa1 = "gnome-terminal --tab -e " + "\"" + "spectre -f nutascii -cols 132 +errpreset=conservative" + " " + aa+ " -r " + oaa+ " =l " + maa+  "\""
ab1 = "gnome-terminal --tab -e " + "\"" + "spectre -f nutascii -cols 132 +errpreset=conservative" + " " + ab+ " -r " + oab+ " =l " + mab+  "\""
ac1 = "gnome-terminal --tab -e " + "\"" + "spectre -f nutascii -cols 132 +errpreset=conservative" + " " + ac+ " -r " + oac+ " =l " + mac+  "\""
ad1 = "gnome-terminal --tab -e " + "\"" + "spectre -f nutascii -cols 132 +errpreset=conservative" + " " + ad+ " -r " + oad+ " =l " + mad+  "\""
#ae1 = "gnome-terminal --tab -e " + "\"" + "spectre -f nutascii -cols 132 +errpreset=conservative" + " " + ae+ " -r " + oae+ " =l " + mae+  "\""
#af1 = "gnome-terminal --tab -e " + "\"" + "spectre -f nutascii -cols 132 +errpreset=conservative" + " " + af+ " -r " + oaf+ " =l " + maf+  "\""
#ag1 = "gnome-terminal --tab -e " + "\"" + "spectre -f nutascii -cols 132 +errpreset=conservative" + " " + ag+ " -r " + oag+ " =l " + mag+  "\""
#ah1 = "gnome-terminal --tab -e " + "\"" + "spectre -f nutascii -cols 132 +errpreset=conservative" + " " + ah+ " -r " + oah+ " =l " + mah+  "\""
#ai1 = "gnome-terminal --tab -e " + "\"" + "spectre -f nutascii -cols 132 +errpreset=conservative" + " " + ai+ " -r " + oai+ " =l " + mai+  "\""
#aj1 = "gnome-terminal --tab -e " + "\"" + "spectre -f nutascii -cols 132 +errpreset=conservative" + " " + aj+ " -r " + oaj+ " =l " + maj+  "\""
#ak1 = "gnome-terminal --tab -e " + "\"" + "spectre -f nutascii -cols 132 +errpreset=conservative" + " " + ak+ " -r " + oak+ " =l " + mak+  "\""
#
...
print a1
print "break"
z =  a1 + " ; " + b1 + " ; " + c1 + " ; " + d1 + " ; " + e1 + " ; " + f1 + " ; " + g1 + " ; " + h1 + " ; " + i1 + " ; " + j1 + " ; " + k1 + " ; " + l1 + " ; " + m1 + " ; " + n1 + " ; " + o1 + " ; " + p1 + " ; " + q1 + " ; " + r1 + " ; " + s1 + " ; " + t1 + " ; " + u1 + " ; " + v1 + " ; " + w1 + " ; " + x1 + " ; " + y1 + " ; " + z1 + " ; " + aa1 + " ; " + ab1 + " ; " + ac1 + " ; " + ad1 
#+ " ; " + ae1 + " ; " + af1 + " ; " + ag1 + " ; " + ah1 + " ; " + ai1 + " ; " + ak1
print z
#
os.system(z)
#os.system(a1)
os.system("echo grep -rnw \"errors\" ./*.msg")
