...
a1 = "gnome-terminal --tab -e " + "\"" + "spectre" + " " + a + "\""
b1 = "gnome-terminal --tab -e " + "\"" + "spectre" + " " + b + "\""
c1 = "gnome-terminal --tab -e " + "\"" + "spectre" + " " + c + "\""
d1 = "gnome-terminal --tab -e " + "\"" + "spectre" + " " + d + "\""
e1 = "gnome-terminal --tab -e " + "\"" + "spectre" + " " + e + "\""
f1 = "gnome-terminal --tab -e " + "\"" + "spectre" + " " + f + "\""
g1 = "gnome-terminal --tab -e " + "\"" + "spectre" + " " + g + "\""
h1 = "gnome-terminal --tab -e " + "\"" + "spectre" + " " + h + "\""
i1 = "gnome-terminal --tab -e " + "\"" + "spectre" + " " + i + "\""
j1 = "gnome-terminal --tab -e " + "\"" + "spectre" + " " + j + "\""
k1 = "gnome-terminal --tab -e " + "\"" + "spectre" + " " + k + "\""
l1 = "gnome-terminal --tab -e " + "\"" + "spectre" + " " + l + "\""
